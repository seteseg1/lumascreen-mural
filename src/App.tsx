...
// ==========================================
// COMPONENTE DA TELA DE TESTE ISOLADO
// ==========================================
function TestScreen({ testSlug, clientTestName, loadingTest, testExists }: { testSlug: string; clientTestName: string; loadingTest: boolean; testExists: boolean }) {
